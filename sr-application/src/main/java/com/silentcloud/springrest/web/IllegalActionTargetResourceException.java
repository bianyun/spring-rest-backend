...
public class IllegalActionTargetResourceException extends CustomWebLayerException {
    ...
    public IllegalActionTargetResourceException(Object id, String resourceLabel, String actionLabel) {
